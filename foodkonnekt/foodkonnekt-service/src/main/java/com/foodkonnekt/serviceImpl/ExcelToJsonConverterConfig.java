...
public class ExcelToJsonConverterConfig {
	...
	private boolean parsePercentAsFloats = true;
	private boolean omitEmpty = true;
	private boolean pretty = true;
	private boolean fillColumns = true;
	private int numberOfSheets = 4;
	...
	public static ExcelToJsonConverterConfig create(CommandLine cmd) {
		...
		config.omitEmpty = true;//!cmd.hasOption("empty");
		config.pretty = true;//cmd.hasOption("pretty");
		config.fillColumns = true;//cmd.hasOption("fillColumns");
