    ...
    <main>
    	...
    	<div class="login-form">
			<div class="avtar text-center">
				<h3>Login</h3>
				<span style="color: red;" id="orderMsgSpanId">${param.loginresponse}</span><br>
			</div>
			
					<form:form method="POST" action="merchantLogin" modelAttribute="MerchantLogin" id="setAdminLoginForm" autocomplete="off" >
						...
						<div class="key">
							<div class="input-field">
					          <!-- <input id="pass" required type="password" class="validate" minlength="8" maxlength="50"> -->
            ...
            <div class="row nomargin">
                <div class="fpass col-sm-6 nopadding">
                  <a href="forgotpassword">Forgot your password?</a>
                </div>
              <div class="signin col-sm-6 text-right nopadding">
                <button type="submit" class="waves-effect waves-light btn white-text">Login</button>
              </div>
              </div>
              </form:form>
    ...
    <footer>
    	<div class="row nomargin">
          ...
          <div class="footer-copyright">
            <div class="col-sm-6">
            Powered by foodkonnekt | copyright@foodkonnekt.com
            </div>
