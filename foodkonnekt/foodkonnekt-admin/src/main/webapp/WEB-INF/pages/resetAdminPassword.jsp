			...
			<div class="inner-container">
				<div class="max-row">
					...
					<div id="page-content clearfix">
						...
						<b><font size="4">Reset Password</font></b></span>
						<label id="errorBox" style="color: red;"></label>
						</div>
						<%-- <form action="LoginByCustomer"> --%>
						<form:form method="POST" modelAttribute="Customer"
														id="myform" name="myform" action="saveAdminPassword"
							...
							<div class="row">
								...
								<p></p><p></p><p></p><p></p>
                                    ...
                                    <input type="submit" class="success hollow button" value="Set Password" onclick="return checkPassword()">
									</div>
