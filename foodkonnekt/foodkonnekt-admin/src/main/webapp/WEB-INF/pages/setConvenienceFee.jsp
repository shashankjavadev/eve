...
<div id="confirm_content" style="display:none">
    ...
    <h3>Your convenience fee has been successfully saved</h3>
    </div>
    <div class="confirmModal_footer">
        <button type="button" class="btn btn-primary uploadedBtn" data-confirmmodal-but="ok" onclick="setAdmiPanel()" >Continue</button>
    </div>
</div>
			...
			<div class="inner-container">
				<div class="max-row">
					...
					<div id="page-content clearfix">
						...
						<b><font size="4">SETUP CONVENIENCE FEE</font></b></span>
						<label id="errorBox" style="color: red;"></label>
							...
							<div class="row">
								...
								<p></p><p></p><p></p><p></p>
									...
									<price>$</price>	
                                    <form:input path="convenienceFee" maxlength="10" class="dollar" id="convenienceFee" type='Number' onkeypress="return isNumberKey(event)"  onblur="currectNo(event)"/>								
									<br>
									<div class="clearfix"></div>									
									...
									<input type="button" value="Save" id="setConvenienceFeeButton" style="height: 43px;">
                                    <a href="adminPanel" style="float: left;height: 43px;">Skip</a>
									</div>
