                                                            ...
                                                            <div class="add-coupon-container">
                                                                <div class="add-coupon-container-form">
                                                                     <form:form method="POST" action="saveDeliveryZone"  modelAttribute="Zone" id="setDeliveryZoneForm" autocomplete="off" name="formID">
                                                                        ...
                                                                        <form:input path="zoneDistance" maxlength="10" id="zoneDistance" type='Number' onkeypress="return isNumberKey(event)"  onblur="currectNo(event)" min="0"/>
                                                                        
                                                                        <label>Min Order Amount:</label>
                                                                        <div class="dollar-sign-left-coupon">
                                                                             <form:input path="minDollarAmount" maxlength="10" id="minDollarAmount" type='Number' onkeypress="return isNumberKey(event)"  onblur="currectNo(event)" min="0"/>
                                                                        </div><!--.dollar-sign-left-->
                                                                        
                                                                        <label>Delivery Fee:</label>
                                                                        <div class="dollar-sign-left-coupon">
                                                                              <form:input path="deliveryFee" maxlength="10" id="deliveryFee" type='Number' onkeypress="return isNumberKey(event)"  onblur="currectNo(event)" min="0"/>
                                                                        </div><!--.dollar-sign-left-->
                                                                        
                                                                        <label> Avg Delivery time in minutes:</label>
                                                                         <form:input path="avgDeliveryTime" maxlength="10" id="avgDeliveryTime" type='Number' onkeypress="return isNumberKey(event)"  onblur="currectNo(event)" min="1" />
                                                                        <div class="clearfix"></div>
                                                                        ...
                                                                        <div class="button left">
                                                                             <input type="button" value="Save" id="setZoneButton">&nbsp;&nbsp;<input type="button" value="Cancel" id="setZoneCancelButton">
                                                                        </div><!--.button-->
      ...
      var status=0;
          $(document).ready(function() {
            ...
            $("#setZoneButton").click(function() {
              ...
              else if (avgDeliveryTime >0 & avgDeliveryTime!= "" & avgDeliveryTime.indexOf('.')!= -1 ) {
            	  
                  $("#avgDeliveryTime").focus();
                  $("#deliveryFee").css('border-color', '');
              	  $("#avgDeliveryTime").css('border-color', 'red');
                  $("#errorBox").html("Average Delivery Time can't be decimal");
                  return false;
