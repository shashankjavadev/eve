...
var isConvenienceFeeStatus="";
var convenienceFeePrice="";
var convenienceFeePosId="";
var convenienceFeeTax="";
var convenienceFeeTaxWithComma="";
                                                                               ...
                                                                               <input type="hidden" id="orderType">
                                                                                <ul>
                                                                                    <li>
                                                                                      ...
                                                                                      <li id="deliveryzoneStatus" style="display: none">
        ...
        <div class="confirmModal_content sd-popup-content">
            ...
            <h3 style="font-size: 14px;">
                <b>We are sorry. We are closed now. Please place your order
                    during our regular operating hours.Today's Operating Hours</br><lable id="openingClosingHours"></lable>
                </b>
            </h3>
        </div>
        <div class="confirmModal_footer">
...
function customerSessionTimeOut(){
    ...
    $(document).ready(function() {
    	...
    	$.ajax({
            url : "getConvenienceFeeStatus",
            type : "GET",
            contentType : "application/json; charset=utf-8",
            success : function(menuItems) {
           	 
           	 var result = JSON.parse(menuItems);
           	 isConvenienceFeeStatus = result.isConvenienceFeePrice;
           	 convenienceFeePrice = result.convenienceFeePrice;
           	 convenienceFeePosId = result.convenienceFeePosId;
           	 convenienceFeeTax = result.convenienceFeeTax;
            convenienceFeeTaxWithComma = result.convenienceFeeTaxWithComma;
          
           
         /*   alert(isConvenienceFeeStatus);
           alert(convenienceFeePrice);
           alert(convenienceFeePosId); 
           alert(convenienceFeeTax); 
           alert(convenienceFeeTaxWithComma);  */
