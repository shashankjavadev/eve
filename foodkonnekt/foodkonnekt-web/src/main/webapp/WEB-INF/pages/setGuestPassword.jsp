...
$(document).ready(function() {
	...
	var bgColor='#f8981d';
	 ...
	 $(".button.hollow.success").css('color', bgColor);
   	...
   	$(".button.hollow.success").css('background-color', bgColor);
   	$(".button.hollow.success").css('color', 'white');
                    ...
                    <div class="useless-inner-container">
                      <div class="sd-page-container">
                        <div id="sd-form-container">
                          <form:form method="POST" modelAttribute="Customer" id="myform" name="myform" action="saveGuestPassword"
                                ...
                                <div class="tabs-panel is-active" id="existing">
                                  ...
                                  <div class="small-12 medium-12 large-12 columns">
                                   ...
                                   <div class="small-12 medium-12 large-12 columns">
                                    ...
                                    <input type="password" placeholder="Enter confirm password" id="confirmPassword" />
                                  </div>
                                  <div class="small-12 medium-12 large-12 columns sd-right">
                                    <input type="submit" class="success hollow button" value="Set Passowrd" onclick="return checkPassword()">
                                  </div>
                                </div>
                              </div>
                            </div>
