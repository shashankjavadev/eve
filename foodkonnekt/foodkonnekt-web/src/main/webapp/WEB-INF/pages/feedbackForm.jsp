		...
		<div class="container feedbackTwo">
			...
			<div class="fs-form-full text-right socialIcons">
				...
				<div class="fs-title text-center">
					...
					<img src="/${merchantLogo}" onerror="this.src='resources/img/logo.png'" width="250" height="150" class="boxMeUp" />
				</div>
    ...
    <c:choose>
			...
			<form:hidden path="orderR.id" value="${orderR.id}" />
				...
				<c:forEach items="${FeedbackQuestionCategories}" var="view"
					varStatus="status">
						...
						<li>
							<div class="boxed-block boxed-top">
								...
								<form:input path= "customer.emailId" type="email" placeholder="Email" id="email-register" readonly="true"  required="required" value="${orderR.customer.emailId}"></form:input>
								...
								<form:input path="customer.phoneNumber" type="text" placeholder="Phone" maxlength="16" id="phone-register" readonly="true" required="required" value="${orderR.customer.phoneNumber}" oninput='javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);'></form:input>
							<div class="row">
								<label class="fs-field-label fs-anim-upper" for="q9" data-info="">When is your Anniversary?</label>
							...
							<div class="row">
								<label class="fs-field-label fs-anim-upper" for="q9" data-info="">When is your Birthday?</label>
					...
					<!-- <div class="hideForm boxMeUp" id="sudmitButtonDiv">
				...
				<div class="hideForm boxMeUp">
						<p>We have received feedback for this order. Thank You for your time</p>
						<meta http-equiv="refresh" content="3;url=https://www.foodkonnekt.com" /></div>
						<!-- <p><button class="fs-submit" type="submit" id="submitButton" onclick="window.location='feedbackshare.html';">Submit Your Feedback</button></p> -->
						<!-- <p><input type="button" class="fs-submit"  value="Save" id="submitButton" onclick="window.location='feedbackshare.html';" >Submit Your Feedback</p> -->
						 <!-- onclick="saveCustomer()" -->
				</div>
				...
				<div class="fs-form-overview hideForm" style="display: block;text-align: center;">
				<p>Feedback form is not enabled. Please contact the restaurant</p>
				</div>
				</c:when>
				...
				<p>Feedback form is not enabled. Please contact the restaurant</p>
                     ...
                     <div class="fs-form-overview" style="display: none;text-align: center;" id="alreadyHaveFeedback">
						<div class="hideForm boxMeUp">
						<p>We have received feedback for this order. Thank You for your time</p></div>
				...
				<div class="fs-form-overview" style="display: none;text-align: center;" id="afterFeedback">
						   <div class="hideForm boxMeUp">
                                             <p>Thank you for your feedback !</p></div>
		...
		<script src="resources/kritiq/js/fullscreenForm1.js"></script>
		...
		<script>
			...
			submitBtn[0].classList.value = "fs-submit-btm disable-continue-btn";
			  ...
			  $('.fs-submit-btm').on('click',  function () {
				 ...
				 var myform = document.getElementById("myform");
			        ...
			        $.ajax({
			            url: "saveCustomerFeedbackUsingAjax",
			            data: fd,
			            cache: false,
			            processData: false,
			            contentType: false,
			            ...
			            success: function (responseBody) {
			              ...
			              if(responseBody=='200'){
			            	  ...
			            	  $(".fs-submit-btm").css("display","none");
			            	  $("#sudmitButtonDiv").css("display","none");
			            	  $(".fs-back").css("display","none");
			            	  $(".fs-continue").css("display","none");
